...
| eos | **[v2.0 新增]** EOS |
| litecoin | **[v2.1 新增]** Litecoin |
| bitcoincash | **[v2.1 新增]** Bitcoin Cash |
| doge | **[v2.1 新增]** Doge |
| polkadot | **[v2.1 新增]** Polkadot Asset Hub |
| cardano | **[v2.1 新增]** Cardano |
| tezos | **[v2.1 新增]** Tezos |
| etc | **[v2.1 新增]** Ethereum Classic |
| avalanche_c_chain | **[v2.1 新增]** Avalanche C-Chain |

### 4.5 支援的資產類型

| Asset | Network | 說明 |
|------|------|------|
| BTC | bitcoin, bsc, arbitrum | Bitcoin |
| ETH | ethereum, bsc | Ethereum |
| USDT | ethereum, tron, bsc, polygon, arbitrum, avalanche_c_chain | Tether USD |
| USDC | ethereum, polygon, solana, arbitrum | USD Coin |
| XRP | xrp | **[v2.0 新增]** XRP |
| LTC | litecoin | **[v2.1 新增]** Litecoin |
| BCH | bitcoincash | **[v2.1 新增]** Bitcoin Cash |
| TRX | tron | **[v2.1 新增]** TRX |
| MAX | ethereum | **[v2.1 新增]** MAX Token |
| DAI | ethereum | **[v2.1 新增]** DAI |
| LINK | ethereum | **[v2.1 新增]** LINK |
| COMP | ethereum | **[v2.1 新增]** COMP |
| PAXG | ethereum | **[v2.1 新增]** PAXG |
| SAND | ethereum | **[v2.1 新增]** SAND |
| GRT | ethereum | **[v2.1 新增]** GRT |
| YFI | ethereum | **[v2.1 新增]** YFI |
| DOGE | doge | **[v2.1 新增]** DOGE |
| ADA | cardano | **[v2.1 新增]** ADA |
| DOT | polkadot | **[v2.1 新增]** DOT |
| POL | ethereum, polygon | **[v2.1 新增]** POL |
| UNI | ethereum | **[v2.1 新增]** UNI |
| XLM | stellar | **[v2.1 新增]** XLM |
| AAVE | ethereum | **[v2.1 新增]** AAVE |
| SOL | solana | **[v2.1 新增]** SOL |
| SHIB | ethereum | **[v2.1 新增]** SHIB |
| GALA | ethereum | **[v2.1 新增]** GALA |
| MANA | ethereum | **[v2.1 新增]** MANA |
| ALICE | ethereum | **[v2.1 新增]** ALICE |
| MASK | ethereum | **[v2.1 新增]** MASK |
| APE | ethereum | **[v2.1 新增]** APE |
| XTZ | tezos | **[v2.1 新增]** XTZ |
| GMT | solana | **[v2.1 新增]** GMT |
| GST | solana | **[v2.1 新增]** GST |
| BNB | bsc | **[v2.1 新增]** BNB |
| ENS | ethereum | **[v2.1 新增]** ENS |
| ETC | etc | **[v2.1 新增]** ETC |
| CHZ | ethereum | **[v2.1 新增]** CHZ |
| LDO | ethereum | **[v2.1 新增]** LDO |
| ARB | arbitrum | **[v2.1 新增]** ARB |
| AVAX | avalanche_c_chain | **[v2.1 新增]** AVAX |
